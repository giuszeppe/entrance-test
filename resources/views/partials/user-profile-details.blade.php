<div class="user-profile-sidebar">
    ...
    <div class="p-3 border-bottom">
        <div class="user-profile-img">
            <img src="images/users/avatar-2.jpg" class="profile-img rounded" alt="">
            ...
            <ul class="list-unstyled chat-list mx-n4">
                <li>
                    <a href="javascript: void(0);">
                        <div class="d-flex align-items-center">
                            <img src="images/users/group-img.jpg" alt="" class="avatar-sm rounded-circle me-3">
            ...
            <div class="profile-media-img">
                <div class="row g-1">
                    <div class="col-lg-4 col-6">
                        <a href="#">
                            <img src="images/small/img-1.jpg" alt="media img" class="img-fluid rounded">
                        </a>
                    </div>
                    <div class="col-lg-4 col-6">
                        <a href="#">
                            <img src="images/small/img-2.jpg" alt="media img" class="img-fluid rounded">
                        </a>
                    </div>
                    <div class="col-lg-4 col-6">
                        <a href="#">
                            <img src="images/small/img-3.jpg" alt="media img" class="img-fluid rounded">
                        </a>
                    </div>
                    <div class="col-lg-4 col-6">
                        <a href="#">
                            <img src="images/small/img-4.jpg" alt="media img" class="img-fluid rounded">
                        </a>
                    </div>
                    <div class="col-lg-4 col-6">
                        <a href="#">
                            <img src="images/small/img-5.jpg" alt="media img" class="img-fluid rounded">
                        </a>
                    </div>
                    <div class="col-lg-4 col-6">
                        <div class="position-relative rounded overflow-hidden">
                            <a href="javascript:void(0);" class="d-block">
                                <img src="images/small/img-6.jpg" alt="media img" class="img-fluid rounded">
